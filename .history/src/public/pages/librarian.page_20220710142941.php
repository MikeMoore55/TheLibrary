...
<main class="librarian">
    ...
    <div id="add-modal" class="add-modal">
        ...
        <form class="add-form" method="POST">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput2" name="book_author">
            <label for="exampleFormControlInput1" class="form-label">
                year released:
            </label>
            <input type="date-year" class="form-control" id="exampleFormControlInput3" name="book_year">
            <label for="exampleFormControlInput1" class="form-label">
                genre:
            </label>
            <input type="text" class="form-control" id="exampleFormControlInput3" name="book_genre">
