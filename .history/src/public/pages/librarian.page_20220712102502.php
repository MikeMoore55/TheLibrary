...
<?php
    ...
    else if (isset($_POST["search-by"])){
        $search = $_POST['search'];
        
        $sql =  "SELECT * from books where book_name like '%$search%' OR book_year like '%$search%' OR book_genre like '%$search%'  OR author_name like '%$search%' OR author_id like '%$search%'";
    }
    else{
