...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]== "POST"){
        ...
        $sql = "SELECT user_id, username, user_age, user_password, user_type FROM user_info WHERE username = $username";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "id: " . $row["user_id"]. " - Name: " . $row["username"]. " " . $row["age"]. " ". $row["user_type"]. "<br>";
            }
        } else {
            echo "0 results";
        }
